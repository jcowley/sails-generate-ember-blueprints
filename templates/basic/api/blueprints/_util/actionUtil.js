...
module.exports = {
   ...
   * @param {User} user The user who made the request (if the user is authenticated)
   ...
   */
  emberizeJSON: function ( model, records, associations, sideload, user, meta ) {
    ...
    var prepareOneRecord = function ( record ) {
      ...
      record = create( {}, record.toJSON(user) );
